...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    mysqli_query($conn, "INSERT INTO review (id_user, rating, text_review, created_at) 
                        VALUES ('$id_user', '$rating', '$text_review', NOW())");
...
<div class="flex-1 ml-64 p-8">
    <h1 class="text-3xl font-semibold mb-6">Tambah Review</h1>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="text_review" class="w-full border rounded px-3 py-2" rows="3" required></textarea>
            </div>
